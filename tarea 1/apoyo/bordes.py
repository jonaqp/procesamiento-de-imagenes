# Prewitt.py
# Tomado de: http://alwaysmovefast.com/2007/12/05/basic-edge-detection-in-python/
	...
	for y in xrange(height):
		for x in xrange(width):
			...
			if y == 0 or y == height-1: magnitude = 0
				...
				for i in xrange(-1, 2):
					for j in xrange(-1, 2):
						# convolve the image pixels with the Prewitt mask, approximating
...
if __name__ == '__main__':
	...
	# Solo funciona con imagenes en blanco y negro..
